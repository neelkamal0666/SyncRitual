...
public class Client {
    ...
    public Client(String dirName, String fullDirName, String serverIP, int port) {
        ...
        System.out.println("Droid Client Selected!");
    ...
    public void runClient() throws Exception {
        ...
        if(dirName.equalsIgnoreCase("-ls")) {
            ...
            System.out.print("Congratulations! Sync ritual has been started.");
            ...
            System.out.println();
            System.out.println("Congratulations again! Sync ritual has been completed. May the force be with you.");
        }
        oos.close();
        ois.close();
        sock.close();
