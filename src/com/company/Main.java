        ...
        try {
            if(args.length > 0) {
                if (args[0].equalsIgnoreCase("-s")) {
                    ...
                    System.out.println("Congratulations!! You have found the secret testing function!");
                    fullPathName = args[1];
                    ...
                    System.out.println("Not a valid entry mate. Usage: java Main [-s] [-c [server IP] [dir to sync OR -ls]]");
                }
            } else {
                System.out.println("Not a valid entry mate. Usage: java Main [-s] [-c [server IP] [dir to sync OR -ls]]");
            }
